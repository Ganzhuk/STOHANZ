<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="STOHANZ.Models.Admin.Orders" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="outerContainer">
        <table id="ordersTable">
            ...
            <tbody>
                <asp:Repeater ID="Repeater1" runat="server" SelectMethod="GetOrders" ItemType="STOHANZ.Models.Order" >
                    <ItemTemplate>
                        <tr>
                            <td><%#: Item.Name %></td>
                            <td><%#: Item.City %></td>
