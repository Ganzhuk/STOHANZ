<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Listing.aspx.cs" Inherits="STOHANZ.Pages.Listing" MasterPageFile="~/Pages/STOHanz.Master" %>
<%@ Import Namespace="System.Web.Routing" %>
<asp:Content ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
      <asp:Repeater ItemType="STOHANZ.Models.Services" SelectMethod="GetServices" runat="server">
          <ItemTemplate>
              <div class="item">
                  <h3><%# Item.Name %></h3>
                  <%# Item.Description %>
